Shader "Phunky/phunky-toon-shader-stencil-2-keep" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                clip((((1.0 - _DissolveAmount)*1.2+-0.6)+_DissolveTexture_var.a) - 0.5);
...
////// Emissive:
                ...
                return fixed4(finalColor,((((1.0 - _DissolveAmount)*1.2+-0.6)+_DissolveTexture_var.a)) * 2.0 - 1.0);
            }
            ENDCG
        }
        Pass {
